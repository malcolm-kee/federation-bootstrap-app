/******/ (function () {
  ...
  /******/ var __webpack_modules__ = {
    /***/ 'webpack/container/reference/@mkeeorg/shell-app':
      /*!****************************************************************************!*\
  !*** external "mother@[window._endpoints.bootstrap.shell]/remoteEntry.js" ***!
  \****************************************************************************/
      /***/ function (module, __unused_webpack_exports, __webpack_require__) {
        'use strict';
        var __webpack_error__ = new Error();
        module.exports = new Promise(function (resolve, reject) {
          if (typeof mother !== 'undefined') return resolve();
          __webpack_require__.l(
            window._endpoints.bootstrap.shell + '/remoteEntry.js',
            function (event) {
              if (typeof mother !== 'undefined') return resolve();
              var errorType =
              ...
              console.log('error in bootstrap code webpack runtime');
  ...
  /******/
  /******/ /******/ __webpack_require__.m = __webpack_modules__; /* webpack/runtime/create fake namespace object */
  /******/
  /************************************************************************/
  /******/ /******/ !(function () {
  ...
  /******/ /******/ !(function () {
    /******/ var inProgress = {};
    /******/ var dataWebpackPrefix = 'federation-bootstrap-app:'; // loadScript function to load a script via script tag
    /******/ /******/ __webpack_require__.l = function (
      ...
      console.log('in webpack runtime l', url, key);
      /******/ if (inProgress[url]) {
      ...
      /******/ if (!script) {
        console.log('creating script for', url);
        /******/ needAttach = true;
      ...
      /******/ var onScriptComplete = function (prev, event) {
        console.log('webpack runtime on script complete', event); // avoid mem leaks in IE.
  ...
  /******/ /******/ !(function () {
    /******/ var chunkMapping = {
      /******/ 'webpack_container_remote_mkeeorg_shell-app_bootstrap': [
        /******/ 'webpack/container/remote/@mkeeorg/shell-app/bootstrap',
        /******/
      ],
      /******/
    };
  ...
  /******/ /******/ !(function () {
    ...
    /******/ __webpack_require__.I = function (name, initScope) {
      ...
      /******/ var uniqueName = 'federation-bootstrap-app';
  ...
  /******/ /******/ !(function () {
    ...
    /******/ __webpack_require__.f.j = function (chunkId, promises) {
      ...
      /******/ if (installedChunkData !== 0) {
        ...
        /******/ if (installedChunkData) {
          ...
          /******/ if (
            'webpack_container_remote_mkeeorg_shell-app_bootstrap' != chunkId
          ) {
    ...
    /******/ var chunkLoadingGlobal = (self[
      'webpackChunkfederation_bootstrap_app'
    ] = self['webpackChunkfederation_bootstrap_app'] || []);
  ...
  !*** ./src/index.js ***!
  \**********************/
    const federationEndpoint = 'http://localhost:8168/federations/bootstrap';
    fetch(federationEndpoint)
      .then((res) => res.json())
      .then(({ endpoints }) => {
        console.log('get endpoints', endpoints);

        if (!window._endpoints) {
          window._endpoints = {};
        }

        window._endpoints.bootstrap = endpoints;
        window._endpoints.shell = {
          career: 'https://federation-career-versions.netlify.app/v2',
        };
        document.getElementById('btn').addEventListener('click', () => {
          __webpack_require__
            .e(/*! import() */ 'src_init_js')
            .then(
